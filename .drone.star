...
def main(ctx):
  ...
  osx_cxx("TOOLSET=clang COMPILER=clang++ CXXSTD=03,11,1 Job 25", "clang++", packages="", buildtype="boost", environment={'TOOLSET': 'clang', 'COMPILER': 'clang++', 'CXXSTD': '03,11,14,1z', 'DRONE_JOB_UUID': 'f6e1126ced'}, globalenv=globalenv),
  ]
